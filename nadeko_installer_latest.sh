...
if [ ! -d NadekoBot ]
then
    mv "$tempdir"/Libria-tyan NadekoBot
else
	...
	cp -RT "$root/NadekoBot/src/NadekoBot/bin/Release/netcoreapp1.1/data/NadekoBot.db" "$root/src/NadekoBot/bin/Release/netcoreapp2.1/data/NadekoBot.db" 1>/dev/null 2>&1
